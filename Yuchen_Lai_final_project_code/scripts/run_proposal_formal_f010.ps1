...
$experiments = @(
    @{ RunName = "proposal_r2plus1d_visual_only_f010_formal_e100_v1"; Method = "visual_only"; LambdaAlign = 0.0 },
    @{ RunName = "proposal_r2plus1d_align_l01_f010_formal_e100_v1"; Method = "proposed"; LambdaAlign = 0.1 }
)
