...
$experiments = @(
    @{ RunName = "proposal_r2plus1d_align_l001_f025_scout_e20_v1"; LambdaAlign = 0.01 },
    @{ RunName = "proposal_r2plus1d_align_l005_f025_scout_e20_v1"; LambdaAlign = 0.05 },
    @{ RunName = "proposal_r2plus1d_align_l01_f025_scout_e20_v1"; LambdaAlign = 0.1 }
)
